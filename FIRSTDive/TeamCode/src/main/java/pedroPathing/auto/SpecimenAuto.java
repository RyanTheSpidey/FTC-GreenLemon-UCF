...
import static pedroPathing.constants.AutoConstants.positionThreshold;
...
public class SpecimenAuto extends OpMode {
    ...
    private PathChain prepSpikeMark1, pushSpikeMark1, prepSpikeMark2, pushSpikeMark2, prepSpikeMark3, pushSpikeMark3, grab1, score1, grab2, score2, grab3, score3, grab4, score4;
    ...
    public void buildPaths(){
        ...
        prepSpikeMark1 = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(specimenPreloadPose.getHeading(), specimenSpikeLeftPose.getHeading())
                .build();
        ...
        prepSpikeMark3 = follower.pathBuilder()
                .addPath(new BezierLine(new Point(specimenObservationMiddlePose), new Point(specimenSpikeRightPose)))
                .setLinearHeadingInterpolation(specimenObservationMiddlePose.getHeading(), specimenSpikeRightPose.getHeading())
                .build();

        pushSpikeMark3 = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(specimenSpikeRightPose), new Point(specimenObservationRightControlPose), new Point(specimenObservationRightPose)))
                .setLinearHeadingInterpolation(specimenSpikeRightPose.getHeading(), specimenObservationRightPose.getHeading())
                .build();

        grab1 = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(specimenObservationMiddlePose), new Point(specimenWallSpecimenControlPose), new Point(specimenWallSpecimenPose)))
                .setLinearHeadingInterpolation(specimenObservationRightPose.getHeading(), specimenWallSpecimenPose.getHeading())
                .build();
...
//        park = new Path(new BezierLine(new Point(specimenChamber4Pose), new Point(specimenObservationParkPose)));
//        park.setLinearHeadingInterpolation(specimenChamber4Pose.getHeading(), specimenObservationParkPose.getHeading());
    }
...
//            case 6:
//                if (follower.atParametricEnd()){
//                    follower.followPath(pushSpikeMark3, true);
//                    setPathState(7);
//                }
//                break;
//            case 7:
//                if (follower.atParametricEnd() || pathTimer.getElapsedTimeSeconds() > 7) {
...
//                break;
            case 8:
                ...
                if (follower.getVelocity().getMagnitude() < 1 && follower.getCurrentTValue() > 0.5) {
                    ...
                    if (actionTimer.getElapsedTimeSeconds() > 0.3){ //0.6
                        actionTimerActive = false;
