...
@Disabled
@Autonomous
public class SampleAutoV3 extends OpMode {
    ...
    private static final Pose preloadPose = new Pose(125, 10.2, Math.toRadians(175));
    private static final Pose basketPose = new Pose(126, 10, Math.toRadians(175));
    private static final Pose leftPose = new Pose(118, 20, Math.toRadians(220));
    private static final Pose rightPose = new Pose(122, 14, Math.toRadians(160));
    private static final Pose subPose = new Pose(78, 48, Math.toRadians(90));
