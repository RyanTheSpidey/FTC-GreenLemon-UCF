...
@Autonomous
public class SpecimenAutoV8 extends OpMode {
    ...
    private Pose spikeRightPose = new Pose(/*117.5*/117.3, /*119.6*/119.0, Math.toRadians(135));
    public void buildPaths(){
        ...
        score1 = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(specimenWallSpecimenPose), new Point(specimenWallSpecimenSpline2Pose), new Point(specimenWallSpecimenSpline1Pose.getX(), specimenChamber1Pose.getY() + 2),new Point(specimenChamber1Pose)))
                .setLinearHeadingInterpolation(specimenWallSpecimenPose.getHeading(), specimenChamber1Pose.getHeading())
                .build();

        grab2 = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(specimenChamber1Pose), new Point(specimenWallSpecimenSpline1Pose.getX(), specimenChamber1Pose.getY()), new Point(specimenWallSpecimenSpline2Pose), new Point(specimenWallSpecimenPose)))
                .setLinearHeadingInterpolation(specimenChamber1Pose.getHeading(), specimenWallSpecimenPose.getHeading())
                .build();

        score2 = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(specimenWallSpecimenPose), new Point(specimenWallSpecimenSpline2Pose), new Point(specimenWallSpecimenSpline1Pose.getX(), specimenChamber2Pose.getY() + 2),new Point(specimenChamber2Pose)))
                .setLinearHeadingInterpolation(specimenWallSpecimenPose.getHeading(), specimenChamber2Pose.getHeading())
                .build();

        grab3 = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(specimenChamber2Pose), new Point(specimenWallSpecimenSpline1Pose.getX(), specimenChamber2Pose.getY()), new Point(specimenWallSpecimenSpline2Pose), new Point(specimenWallSpecimenPose.getX(), specimenWallSpecimenPose.getY())))
                .setLinearHeadingInterpolation(specimenChamber2Pose.getHeading(), specimenWallSpecimenPose.getHeading())
                .build();

        score3 = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(specimenWallSpecimenPose), new Point(specimenWallSpecimenSpline2Pose), new Point(specimenWallSpecimenSpline1Pose.getX(), specimenChamber3Pose.getY() + 2),new Point(specimenChamber3Pose)))
        ...
        grab4 = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(specimenChamber3Pose), new Point(specimenWallSpecimenSpline1Pose.getX(), specimenChamber3Pose.getY()), new Point(specimenWallSpecimenSpline2Pose), new Point(specimenWallSpecimenPose)))
                .setLinearHeadingInterpolation(specimenChamber3Pose.getHeading(), specimenWallSpecimenPose.getHeading())
                .build();

        score4 = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(specimenWallSpecimenPose), new Point(130, 107), new Point(specimenWallSpecimenSpline1Pose.getX(), specimenChamber4Pose.getY() + 2), new Point(specimenChamber4Pose)))
                .setLinearHeadingInterpolation(specimenWallSpecimenPose.getHeading(), specimenChamber4Pose.getHeading())
                .build();

        park = new Path(new BezierCurve(new Point(specimenChamber4Pose), new Point(120, specimenChamber4Pose.getY()), new Point(132, 120)));
        park.setLinearHeadingInterpolation(specimenChamber4Pose.getHeading(), Math.toRadians(225), 0.3);
...
//                    }
            ...
            case 2:
                ...
                if (follower.atParametricEnd()){
                    ...
                    follower.followPath(pushSpikeMark1, true);
                    setPathState(3);
                }
                break;
            case 3:
                if (follower.atParametricEnd()){
                    follower.followPath(prepSpikeMark2, true);
                    setPathState(4);
                }
                break;
            case 4:
                if (follower.atParametricEnd()){
                    follower.followPath(pushSpikeMark2, true);
                    setPathState(5);
                }
                break;
            case 5:
...
//                    }
                    ...
                    while (getRuntime() - timestamp < 0.1) {
